...
class SummaryTool{
	...
	void extractSentenceFromContext(){ //this extract sentences from the document and creates a sentence object and it will store in a sentence type array list name call sentences
		int nextChar,j=0;
		int prevChar = -1;
        try{
	...
	void groupSentencesIntoParagraphs(){//from this methode take 
		int paraNum = 0;
...
//	}
	...
	double getWordCount(ArrayList<Sentence> sentenceList){//here find the total no of words in the summery
